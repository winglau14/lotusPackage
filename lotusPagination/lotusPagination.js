...
var lotusPagination = {
    init: function (options) {
            ...
            function createDom(page) {
                ...
                //上一页按钮显示状态
                lotusPagination.prevOrNextChange('lotus-pagination-list-prev', options.index, 'prev');
                //只有一页隐藏下一页按钮
                ...
                var pageCommonFn = function () {
                    ...
                    if (options.index === tarDom.length) {
                        lotusPagination.prevOrNextChange('lotus-pagination-list-next', options.index, 'next', totalPage);
                    } else {
                        //点击其他显示下一页
                        lotusPagination.prevOrNextChange('lotus-pagination-list-next', options.index, 'next', totalPage);
                    }
