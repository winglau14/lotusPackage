...
Z([3,'_div M5b6659fe confirm-item-content'])
Z([[6],[[7],[3,'ConfirmData']],[3,'showImg']])
Z([3,'_img M5b6659fe confirm-item-content-image'])
Z([[2,'?:'],[[6],[[7],[3,'ConfirmData']],[3,'descImage']],[[6],[[7],[3,'ConfirmData']],[3,'descImage']],[[7],[3,'defaultImage']]])
Z([3,'_div M5b6659fe confirm-item-content-text'])
Z([[2,'?:'],[[6],[[7],[3,'ConfirmData']],[3,'descText']],[[6],[[7],[3,'ConfirmData']],[3,'descText']],[1,'想好了吗？']])
Z([3,'_div M5b6659fe confirm-item-click'])
Z([[7],[3,'twoButton']])
Z(z[2])
Z([3,'_span M5b6659fe confirm-item-click-no'])
Z(z[4])
Z([1,'5b6659fe-0'])
Z([[2,'?:'],[[6],[[7],[3,'ConfirmData']],[3,'noText']],[[6],[[7],[3,'ConfirmData']],[3,'noText']],[1,'取消']])
Z(z[2])
Z([3,'_span M5b6659fe confirm-item-click-yes'])
Z(z[4])
Z([1,'5b6659fe-1'])
...
Z([3,'_view M3058b05e lotus-load-more'])
Z([[6],[[7],[3,'lotusLoadMData']],[3,'showLoadImg']])
Z([3,'_view M3058b05e lotus-load-more-img'])
Z([3,'_text M3058b05e'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'7b3f1b4f'])
Z([3,'_view M7b3f1b4f index-splash'])
Z([3,'_view M7b3f1b4f index-splash-top'])
Z([3,'_text M7b3f1b4f'])
Z([a,[[6],[[7],[3,'lotusSplashData']],[3,'welcomeTitle']]])
Z(z[3])
Z([a,[[6],[[7],[3,'lotusSplashData']],[3,'appTitle']]])
Z([3,'_view M7b3f1b4f index-splash-footer'])
Z([3,'_view M7b3f1b4f index-splash-logo'])
Z([a,[3,' '],[[2,'+'],[[2,'+'],[1,'background:url('],[[6],[[7],[3,'lotusSplashData']],[3,'logo']]],[1,') no-repeat;background-size:100% 100%;']]])
Z([3,'_view M7b3f1b4f index-splash-text'])
Z(z[3])
Z([3,'©'])
Z(z[3])
...
Z([3,'_view M19fbbbce express-detail-top'])
Z([3,'_view M19fbbbce express-detail-left'])
Z([3,'_image M19fbbbce'])
Z([3,'aspectFit'])
Z([3,'../../static/images/package-icon.png'])
Z([3,'_view M19fbbbce express-detail-right'])
Z([3,'_view M19fbbbce express-detail-title1'])
Z([3,'快递公司：'])
Z([3,'_text M19fbbbce'])
Z([a,[[2,'||'],[[7],[3,'name']],[1,'--']]])
Z([3,'_view M19fbbbce express-detail-title2'])
Z([a,[3,'快递单号：'],[[7],[3,'qrCode']]])
Z(z[12])
Z([a,[3,'管理状态：'],[[2,'||'],[[7],[3,'context']],[1,'--']]])
Z([[7],[3,'flag']])
Z([3,'_view M19fbbbce express-detail-step-wrap'])
Z([3,'_text M19fbbbce express-detail-step-nav'])
Z([3,'快递状态：'])
Z([3,'showReward'])
Z([3,'_view M19fbbbce express-detail-step-reward'])
Z([3,'_image M19fbbbce express-detail-step-image'])
Z(z[5])
Z([3,'/images/shang-icon2.png'])
Z(z[16])
Z([3,'_view M19fbbbce express-detail-status'])
Z([3,'index'])
Z([3,'item'])
Z([[7],[3,'statusArray']])
Z(z[27])
Z([a,[3,'_view M19fbbbce '],[[2,'?:'],[[2,'=='],[[7],[3,'index']],[1,0]],[1,'express-detail-status-content express-detail-status-act'],[1,'express-detail-status-content']]])
Z([[7],[3,'index']])
...
Z([[7],[3,'noDataFlag']])
Z([3,'_view M19fbbbce express-detail-no-data'])
Z([3,'_image M19fbbbce express-detail-no-data-img'])
Z(z[5])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'76436e79'])
Z([3,'_view M76436e79 fill-form'])
Z([3,'_view M76436e79 fill-form-item'])
Z([3,'_view M76436e79 fill-form-item-l'])
Z([3,'_text M76436e79 fill-form-item-l-red'])
Z([3,'*'])
Z([3,'_text M76436e79'])
Z([3,'名称：'])
Z([3,'_view M76436e79 fill-form-item-r'])
Z([3,'handleProxy'])
Z([3,'_input M76436e79'])
Z([[7],[3,'$k']])
Z([1,'76436e79-0'])
Z([3,'请输入名称'])
Z([3,'text'])
...
Z([[7],[3,'userPhone']])
Z(z[2])
Z([3,'_view M76436e79 fill-form-item-l fill-form-item-top'])
Z(z[4])
Z(z[5])
Z(z[6])
Z([3,'地址：'])
...
Z([3,'_text M76436e79 fill-form-item-tips'])
Z([3,'图片点击可以预览'])
Z([3,'_view M76436e79 fill-form-item-img-list'])
Z([3,'index'])
Z([3,'itemList'])
Z([[7],[3,'imageList']])
Z(z[118])
Z([3,'_view M76436e79 fill-form-item-img-wrap'])
Z([[7],[3,'index']])
Z(z[9])
Z([3,'_image M76436e79 fill-form-item-img'])
Z(z[11])
Z([[2,'+'],[1,'76436e79-7-'],[[7],[3,'index']]])
Z([3,'aspectFit'])
Z([[2,'+'],[[7],[3,'imgWebUrl']],[[6],[[7],[3,'itemList']],[3,'imgUrl']]])
Z(z[9])
Z([3,'_view M76436e79 fill-form-item-delete'])
Z(z[11])
Z([[2,'+'],[1,'76436e79-8-'],[[7],[3,'index']]])
Z([[2,'<'],[[6],[[7],[3,'imageList']],[3,'length']],[1,2]])
Z(z[9])
Z([3,'_view M76436e79 fill-form-item-camera'])
Z(z[11])
Z([1,'76436e79-9'])
Z([3,'_view M76436e79 fill-form-fix'])
Z([3,'_view M76436e79 fill-form-fix-wrap'])
Z(z[9])
Z([3,'_button M76436e79 fill-form-fix-btn lotus-btn'])
Z(z[11])
Z([1,'76436e79-10'])
Z([3,'primary'])
Z([3,'提交'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'6c567299'])
Z([3,'_view M6c567299 form-detail'])
Z([3,'_view M6c567299 form-detail-item'])
Z([3,'_text M6c567299'])
Z([3,'名称：'])
Z(z[3])
...
Z([3,'_view M6c567299'])
Z([3,'附件：'])
Z([3,'_text M6c567299 form-detail-item-tips'])
Z([3,'图片点击可以预览'])
Z([3,'_view M6c567299 form-detail-img-list'])
Z([3,'index'])
Z([3,'item'])
Z([[7],[3,'imageList']])
Z(z[44])
Z([3,'handleProxy'])
Z([3,'_image M6c567299'])
Z([[7],[3,'$k']])
Z([[2,'+'],[1,'6c567299-0-'],[[7],[3,'index']]])
Z([[7],[3,'index']])
Z([3,'aspectFit'])
Z([[2,'+'],[[7],[3,'webUrl']],[[6],[[7],[3,'item']],[3,'imgUrl']]])
Z([3,'_navigator M6c567299 lotus-btn form-detail-btn'])
Z([[2,'+'],[1,'/pages/form/form?id\x3d'],[[7],[3,'buyFormId']]])
Z([3,'编辑'])
Z(z[48])
Z([3,'_view M6c567299 lotus-btn form-detail-delete'])
Z(z[50])
Z([1,'6c567299-1'])
Z([3,'删除'])
...
Z([3,'_image M1a34ca1f express-logo'])
Z([3,'aspectFit'])
Z([3,'../../static/images/logo.png'])
Z([3,'_view M1a34ca1f express-input-module'])
Z([3,'_text M1a34ca1f express-input-text'])
Z([3,'快递单号：'])
Z([3,'handleProxy'])
Z([3,'_input M1a34ca1f uni-input express-input-val'])
Z([3,'search'])
Z([[7],[3,'$k']])
Z([1,'1a34ca1f-0'])
Z([3,'请输入快递单号'])
...
Z([[7],[3,'qrCode']])
Z(z[8])
Z([3,'_image M1a34ca1f express-input-qr'])
Z(z[11])
Z([1,'1a34ca1f-1'])
Z(z[3])
Z([3,'../../static/images/ss-icon.png'])
Z(z[8])
Z([3,'_button M1a34ca1f express-button'])
Z(z[11])
Z([1,'1a34ca1f-2'])
Z([3,'primary'])
Z([3,'查询'])
Z(z[8])
Z([3,'_button M1a34ca1f'])
Z(z[11])
Z([1,'1a34ca1f-3'])
...
Z(z[26])
Z([3,'关闭闪光灯'])
Z([3,'_image M1a34ca1f'])
Z(z[3])
Z([[7],[3,'tempImg']])
Z([[6],[[7],[3,'history']],[3,'length']])
Z([3,'_view M1a34ca1f express-history'])
Z([3,'_text M1a34ca1f express-history-title'])
Z([3,'查询记录'])
Z([3,'_view M1a34ca1f express-history-model'])
Z([3,'index'])
Z([3,'item'])
Z([[7],[3,'history']])
Z(z[57])
Z(z[8])
Z([3,'_view M1a34ca1f express-history-item'])
Z(z[11])
Z([[2,'+'],[1,'1a34ca1f-6-'],[[7],[3,'index']]])
Z([[7],[3,'index']])
Z([3,'_view M1a34ca1f express-history-wrap1'])
Z([3,'_image M1a34ca1f express-history-img'])
Z(z[3])
Z([[2,'+'],[[2,'+'],[1,'https://cdn.kuaidi100.com/images/all/56/'],[[6],[[7],[3,'item']],[3,'codeName']]],[1,'.png']])
Z([3,'_view M1a34ca1f'])
Z([3,'_text M1a34ca1f express-history-company'])
Z([a,[[6],[[7],[3,'item']],[3,'name']]])
Z([3,'_text M1a34ca1f express-history-number'])
Z([a,z[7],[[6],[[7],[3,'item']],[3,'number']]])
Z([[7],[3,'showJqMask']])
Z([3,'_view M1a34ca1f express-jq'])
Z([3,'_view M1a34ca1f express-jq-content'])
Z([3,'_text M1a34ca1f express-jq-title1'])
Z([3,'查询剪贴板的单号'])
Z([3,'_text M1a34ca1f express-jq-title2'])
Z([a,[[7],[3,'qrCode']]])
Z([3,'_view M1a34ca1f express-jq-action'])
Z(z[8])
Z([3,'_text M1a34ca1f express-jq-cancel'])
Z(z[11])
Z([1,'1a34ca1f-7'])
Z([3,'取消'])
Z(z[8])
Z([3,'_text M1a34ca1f express-jq-right'])
Z(z[11])
Z([1,'1a34ca1f-8'])
Z([3,'确定'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'18aaca0d'])
Z([3,'_view M18aaca0d login'])
Z([3,'_view M18aaca0d login-welcome'])
Z([3,'_text M18aaca0d login-welcome-line'])
Z([3,'_text M18aaca0d login-welcome-title'])
Z([3,'使用以下方式登录'])
Z(z[3])
Z([3,'_view M18aaca0d login-list'])
Z([3,'handleProxy'])
Z([3,'_view M18aaca0d login-list-item'])
Z([[7],[3,'$k']])
Z([1,'18aaca0d-0'])
Z([3,'_image M18aaca0d'])
Z([3,'aspectFit'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'1264a47e'])
Z([3,'_view M1264a47e success'])
Z([3,'_image M1264a47e success-img'])
Z([3,'aspectFit'])
Z([3,'../../static/images/success-bg.png'])
Z([3,'_text M1264a47e success-text'])
Z([3,'提交成功，我们将尽快进行处理喔^_^'])
Z([3,'_view M1264a47e success-btn-wrap'])
Z([3,'handleProxy'])
Z([3,'_button M1264a47e mini-btn success-btn-wrap-l'])
Z([[7],[3,'$k']])
Z([1,'1264a47e-0'])
Z([3,'mini'])
Z([3,'default'])
Z([3,'查看详情'])
Z(z[8])
Z([3,'_button M1264a47e mini-btn'])
Z(z[10])
Z([1,'1264a47e-1'])
Z(z[12])
Z([3,'primary'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'5a83f5b9'])
Z([3,'_view M5a83f5b9 user-center lotus-wrap'])
Z([3,'_view M5a83f5b9 user-center-top'])
Z([3,'_image M5a83f5b9 user-center-top-header'])
Z([3,'aspectFit'])
Z([[2,'?:'],[[7],[3,'headerImg']],[[7],[3,'headerImg']],[1,'../../static/images/user-default3.png']])
Z([3,'_view M5a83f5b9 user-center-top-msg'])
Z([3,'_text M5a83f5b9'])
Z([3,'color:#fff;'])
Z([3,'昵称：'])
Z([a,[[2,'?:'],[[7],[3,'nickName']],[[7],[3,'nickName']],[1,'--']]])
Z([3,'_view M5a83f5b9 user-center-list'])
Z([3,'_navigator M5a83f5b9'])
Z([3,'navigate'])
Z([3,'../form/form'])
Z([3,'_view M5a83f5b9 user-center-list-item'])
Z([3,'_image M5a83f5b9 user-center-list-icon'])
Z(z[4])
Z([3,'../../static/images/create-form-icon.png'])
Z([3,'_view M5a83f5b9 user-center-list-text'])
Z([3,'新建'])
Z([3,'_text M5a83f5b9 user-center-list-jt'])
Z(z[12])
Z([3,'switchTab'])
Z([3,'../list/list'])
Z(z[15])
...
Z(z[7])
Z([3,'关于帮您购'])
Z([3,'_text M5a83f5b9 user-center-list-text-r'])
Z([3,'版本1.0.0'])
Z(z[32])
Z([3,'_view M5a83f5b9 user-center-quit'])
Z(z[34])
Z([1,'5a83f5b9-1'])
Z([3,'退出登录'])
Z(z[32])
